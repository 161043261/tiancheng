...
- GET 类比 Map.prototype.get, 安全, 幂等
- POST 类比 Array.prototype.push, 不安全, 非幂等
- PUT 类比 Map.prototype.set, 不安全, 幂等
- DELETE 类比 Map.prototype.delete, 不安全, 幂等
